...
--The table will have two foreign keys refrencing to user id and location id which will create a one to many relationship with users and locations table
